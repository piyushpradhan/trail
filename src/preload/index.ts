...
const api: TrailAPI = {
  ...
  settings: {
    ...
    setSlackToken: (token) => ipcRenderer.invoke('settings:setSlackToken', token),
    clearSlackToken: () => ipcRenderer.invoke('settings:clearSlackToken'),
    setSlackEnabled: (enabled) => ipcRenderer.invoke('settings:setSlackEnabled', enabled),
    setSlackOptions: (opts) => ipcRenderer.invoke('settings:setSlackOptions', opts),
    diagnoseSlack: () => ipcRenderer.invoke('settings:diagnoseSlack'),
